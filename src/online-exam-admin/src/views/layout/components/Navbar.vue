        ...
        <el-dropdown-menu slot="dropdown" class="user-dropdown">
          <el-dropdown-item>
            <div class="progress-item">
              <div class="info_item">
                <span>管理员ID</span>
                <span style="float: right;">{{ userInfo.ano }}</span>
              </div>
            </div>
            <div class="progress-item">
              <div class="info_item">
                <span>姓名</span>
                <span style="float: right;">{{ userInfo.admName }}</span>
              </div>
            </div>
            <div class="progress-item">
              <div class="info_item">
                <span>性别</span>
                <span style="float: right;">{{ userInfo.admSex }}</span>
              </div>
            </div>
            <div class="progress-item">
              <div class="info_item">
                <span>邮箱</span>
                <span style="float: right;">{{ userInfo.admEmail }}</span>
              </div>
            </div>
            <!-- <div class="progress-item">
              <div class="info_item">
                <span>手机号码</span>
                <span style="float: right;">{{ userInfo.admPhone }}</span>
              </div>
            </div> -->
            <div class="progress-item">
              <div class="info_item">
                <span>最近登录时间</span>
                <span style="float: right;">{{ userInfo.admLastLoginTime | date-format }}</span>
              </div>
            </div>
          </el-dropdown-item>
