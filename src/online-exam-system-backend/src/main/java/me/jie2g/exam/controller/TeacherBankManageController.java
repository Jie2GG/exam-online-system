...
public class TeacherBankManageController {
	...
	public ServerResponse getSubjectList () {
		Map<String, Object> map = new HashMap<> ();
		List<Map<String, Object>> subjectsList = adminSubjectService.getSubjectsList ();
		map.put ("subjectsList", subjectsList);
		return ServerResponse.createBySuccess ("获取科目列表成功", map);
	}
