...
import me.jie2g.exam.service.StudentHomeService;
import me.jie2g.exam.service.TeacherPaperService;
import me.jie2g.exam.util.FindContentWithImage;
import me.jie2g.exam.dao.*;
import me.jie2g.exam.domain.*;
...
public class TeacherPaperServiceImpl implements TeacherPaperService {
    ...
    public int randomInsertPaperInfo(Map<String, Object> obj) {
        ...
        if ((paperId = paperMapper.selectMaxPaperId()) == null) {
            paperId = 1;
        } else {
            paperId += 1;
        }
...
//            System.out.println(judgeId + "---" + id);
    ...
    @Override
    public Map<String, Object> getPaperQuesByPaperId (Integer paperId) {
        Map<String, Object> map = new HashMap<>();
        ...
        map.put("singleData", singleChoiceQueList);
        map.put("multipleData", multipleChoiceQueList);
        map.put("judgeData", judgeQueList);
        map.put("fillData", fillQueList);
